	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="./Authenticator" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Por favor insira um usuário válido">
					...
					<div class="wrap-input100 validate-input" data-validate = "Por favor insira uma senha válida">
						<input class="input100" type="password" name="TXTPASS" placeholder="Senha">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
